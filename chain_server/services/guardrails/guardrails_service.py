...
class GuardrailsService:
    ...
    async def check_input_safety(self, user_input: str, context: Optional[Dict[str, Any]] = None) -> GuardrailsResult:
        ...
        try:
            ...
            jailbreak_phrases = [
                ...
                "pretend to be", "act as if", "roleplay as", "simulate", "override",
                "bypass", "jailbreak"
            ]
            ...
            safety_violations = [
                "operate forklift without training", "bypass safety protocols",
                "ignore safety warnings", "work without PPE", "operate equipment unsafely"
            ]
            ...
            security_violations = [
                "security codes", "access restricted areas", "alarm codes",
                "disable security", "warehouse layout for unauthorized access"
            ]
            ...
            compliance_violations = [
                "avoid safety inspections", "skip compliance requirements",
                "ignore regulations", "work around safety rules"
            ]
            ...
            off_topic_phrases = [
                "weather", "joke", "capital of", "how to cook", "recipe",
    ...
    async def check_output_safety(self, response: str, context: Optional[Dict[str, Any]] = None) -> GuardrailsResult:
        ...
        try:
            ...
            dangerous_phrases = [
                "ignore safety", "bypass protocol", "skip training",
                "work without", "operate without", "disable safety"
            ]
            ...
            # Check for compliance violations
            compliance_phrases = [
                "avoid inspection", "skip compliance", "ignore regulation",
                "work around rule", "circumvent policy"
            ]
    ...
    def get_safety_response(self, violations: List[str]) -> str:
        ...
        if jailbreak_violations:
            responses.append("I cannot ignore my instructions or roleplay as someone else. I'm here to help with warehouse operations.")
        
        if safety_violations:
            responses.append("Safety is our top priority. I cannot provide guidance that bypasses safety protocols. Please consult with your safety supervisor.")
        
        if security_violations:
            responses.append("I cannot provide security-sensitive information. Please contact your security team for security-related questions.")
        
        if compliance_violations:
            responses.append("Compliance with safety regulations and company policies is mandatory. Please follow all established procedures.")
        ...
        if not responses:
            responses.append("I cannot assist with that request. Please ask about warehouse operations, inventory, or safety procedures.")
        
        return " ".join(responses) + " How can I help you with warehouse operations today?"

# Global instance
guardrails_service = GuardrailsService(
    GuardrailsConfig(
        rails_file="guardrails/rails.yaml",
        model_name="nvidia/llama-3-70b-instruct"
    )
)
