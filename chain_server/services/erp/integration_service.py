...
from adapters.erp import ERPAdapterFactory, ERPConnection, BaseERPAdapter
...
class ERPIntegrationService:
    ...
    async def add_connection(self, connection_id: str, connection: ERPConnection) -> bool:
    ...
    async def get_employees(
        ...
        if not adapter:
            return ERPResponse(
                success=False,
                error=f"ERP connection not found: {connection_id}"
            )
