...
from chain_server.services.monitoring.metrics import metrics_collector
import logging
...
class SampleMetricsGenerator:
    ...
    def __init__(self):
        ...
        self.incident_types = ["slip", "fall", "equipment_malfunction", "safety_violation"]
        ...
        self.worker_ids = ["worker_001", "worker_002", "worker_003", "worker_004", "worker_005"]
        ...
        while self.running:
            try:
                ...
                if random.random() < 0.05:  # 5% chance every cycle
                    event_type = random.choice(["near_collision", "equipment_malfunction", "safety_violation"])
        ...
        while self.running:
            try:
                ...
                for equipment_id in self.equipment_ids:
                    ...
                    metrics_collector.update_equipment_utilization(equipment_id, equipment_type, utilization)
        ...
        while self.running:
            try:
                ...
                for zone in self.zones:
                    ...
                    metrics_collector.update_environmental_conditions(temperature, humidity, zone)
