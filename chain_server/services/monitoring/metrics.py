...
warehouse_active_users = Gauge(
    'warehouse_active_users',
    'Number of active users'
)

warehouse_tasks_created_total = Counter(
    'warehouse_tasks_created_total',
    'Total tasks created',
    ['task_type', 'priority']
)
...
warehouse_safety_score = Gauge(
    'warehouse_safety_score',
...
class MetricsCollector:
    ...
    def update_equipment_utilization(self, equipment_id: str, equipment_type: str, utilization: float):
    ...
    def update_equipment_status(self, equipment_id: str, status: str):
        ...
        warehouse_equipment_status.labels(
            equipment_id=equipment_id,
            status=status
        ).set(1)
    ...
    def update_environmental_conditions(self, temperature: float, humidity: float, zone: str = "main"):
