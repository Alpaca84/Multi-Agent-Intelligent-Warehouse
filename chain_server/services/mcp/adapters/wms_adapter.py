...
class WMSAdapter(MCPAdapter):
    ...
    def _setup_tools(self) -> None:
        ...
        self.tools["get_inventory_levels"] = MCPTool(
            ...
            parameters={
                "item_ids": {"type": "array", "description": "List of item IDs to query", "required": False},
                "location_ids": {"type": "array", "description": "List of location IDs to query", "required": False},
                "zone_ids": {"type": "array", "description": "List of zone IDs to query", "required": False},
                "include_reserved": {"type": "boolean", "description": "Include reserved quantities", "required": False, "default": True}
            },
        ...
        self.tools["update_inventory"] = MCPTool(
            ...
            tool_type=MCPToolType.FUNCTION,
            parameters={
                "item_id": {"type": "string", "description": "Item ID to update", "required": True},
                "location_id": {"type": "string", "description": "Location ID", "required": True},
                "quantity": {"type": "number", "description": "New quantity", "required": True},
                "reason_code": {"type": "string", "description": "Reason for update", "required": True},
                "reference_document": {"type": "string", "description": "Reference document", "required": False}
            },
        ...
        self.tools["reserve_inventory"] = MCPTool(
            ...
            tool_type=MCPToolType.FUNCTION,
            parameters={
                "item_id": {"type": "string", "description": "Item ID to reserve", "required": True},
                "location_id": {"type": "string", "description": "Location ID", "required": True},
                "quantity": {"type": "number", "description": "Quantity to reserve", "required": True},
                "order_id": {"type": "string", "description": "Order ID", "required": False},
                "task_id": {"type": "string", "description": "Task ID", "required": False},
                "expiry_date": {"type": "string", "description": "Reservation expiry date", "required": False}
            },
        ...
        self.tools["create_order"] = MCPTool(
            ...
            tool_type=MCPToolType.FUNCTION,
            parameters={
                "order_type": {"type": "string", "description": "Type of order (pick, putaway, move, cycle_count)", "required": True},
                "priority": {"type": "integer", "description": "Order priority (1-5)", "required": False, "default": 3},
                "items": {"type": "array", "description": "List of items in the order", "required": True},
                "source_location": {"type": "string", "description": "Source location", "required": False},
                "destination_location": {"type": "string", "description": "Destination location", "required": False},
                "assigned_user": {"type": "string", "description": "Assigned user ID", "required": False}
            },
        ...
        self.tools["get_order_status"] = MCPTool(
            ...
            tool_type=MCPToolType.FUNCTION,
            parameters={
                "order_ids": {"type": "array", "description": "List of order IDs to query", "required": False},
                "status_filter": {"type": "string", "description": "Filter by status", "required": False},
                "date_from": {"type": "string", "description": "Start date filter", "required": False},
                "date_to": {"type": "string", "description": "End date filter", "required": False}
            },
        ...
        self.tools["update_order_status"] = MCPTool(
            ...
            tool_type=MCPToolType.FUNCTION,
            parameters={
                "order_id": {"type": "string", "description": "Order ID to update", "required": True},
                "status": {"type": "string", "description": "New status", "required": True},
                "user_id": {"type": "string", "description": "User performing the update", "required": True},
        ...
        self.tools["create_receipt"] = MCPTool(
            ...
            tool_type=MCPToolType.FUNCTION,
            parameters={
                "supplier_id": {"type": "string", "description": "Supplier ID", "required": True},
                "po_number": {"type": "string", "description": "Purchase order number", "required": True},
                "expected_items": {"type": "array", "description": "Expected items to receive", "required": True},
                "dock_door": {"type": "string", "description": "Dock door assignment", "required": False},
                "scheduled_date": {"type": "string", "description": "Scheduled receiving date", "required": False}
            },
        ...
        self.tools["process_receipt"] = MCPTool(
            ...
            tool_type=MCPToolType.FUNCTION,
            parameters={
                "receipt_id": {"type": "string", "description": "Receipt ID to process", "required": True},
                "received_items": {"type": "array", "description": "Actually received items", "required": True},
                "user_id": {"type": "string", "description": "User processing the receipt", "required": True},
                "quality_check": {"type": "boolean", "description": "Perform quality check", "required": False, "default": True}
            },
        ...
        self.tools["create_pick_list"] = MCPTool(
            ...
            tool_type=MCPToolType.FUNCTION,
            parameters={
                "order_ids": {"type": "array", "description": "Order IDs to include", "required": True},
                "pick_strategy": {"type": "string", "description": "Picking strategy (batch, wave, single)", "required": False, "default": "batch"},
                "zone_optimization": {"type": "boolean", "description": "Enable zone optimization", "required": False, "default": True},
                "user_id": {"type": "string", "description": "Assigned user", "required": False}
            },
        ...
        self.tools["execute_pick"] = MCPTool(
            ...
            tool_type=MCPToolType.FUNCTION,
            parameters={
                "pick_list_id": {"type": "string", "description": "Pick list ID", "required": True},
                "item_id": {"type": "string", "description": "Item ID being picked", "required": True},
                "location_id": {"type": "string", "description": "Location being picked from", "required": True},
                "quantity": {"type": "number", "description": "Quantity picked", "required": True},
                "user_id": {"type": "string", "description": "User performing the pick", "required": True}
            },
        ...
        self.tools["create_shipment"] = MCPTool(
            ...
            tool_type=MCPToolType.FUNCTION,
            parameters={
                "order_ids": {"type": "array", "description": "Order IDs to ship", "required": True},
                "carrier": {"type": "string", "description": "Shipping carrier", "required": True},
                "service_level": {"type": "string", "description": "Service level", "required": True},
                "tracking_number": {"type": "string", "description": "Tracking number", "required": False},
                "ship_date": {"type": "string", "description": "Ship date", "required": False}
            },
        ...
        self.tools["get_shipment_status"] = MCPTool(
            ...
            tool_type=MCPToolType.FUNCTION,
            parameters={
                "shipment_ids": {"type": "array", "description": "Shipment IDs to query", "required": False},
                "tracking_numbers": {"type": "array", "description": "Tracking numbers to query", "required": False},
                "date_from": {"type": "string", "description": "Start date filter", "required": False},
                "date_to": {"type": "string", "description": "End date filter", "required": False}
            },
        ...
        self.tools["get_warehouse_layout"] = MCPTool(
            ...
            tool_type=MCPToolType.FUNCTION,
            parameters={
                "zone_id": {"type": "string", "description": "Specific zone ID", "required": False},
                "include_equipment": {"type": "boolean", "description": "Include equipment information", "required": False, "default": True},
                "include_capacity": {"type": "boolean", "description": "Include capacity information", "required": False, "default": True}
            },
        ...
        self.tools["optimize_warehouse"] = MCPTool(
            ...
            tool_type=MCPToolType.FUNCTION,
            parameters={
                "optimization_type": {"type": "string", "description": "Type of optimization (layout, picking, putaway)", "required": True},
                "zone_ids": {"type": "array", "description": "Zones to optimize", "required": False},
                "constraints": {"type": "object", "description": "Optimization constraints", "required": False},
                "simulation": {"type": "boolean", "description": "Run simulation only", "required": False, "default": False}
            },
        ...
        self.tools["get_warehouse_metrics"] = MCPTool(
            ...
            tool_type=MCPToolType.FUNCTION,
            parameters={
                "metric_types": {"type": "array", "description": "Types of metrics to retrieve", "required": False},
                "date_from": {"type": "string", "description": "Start date", "required": True},
                "date_to": {"type": "string", "description": "End date", "required": True},
                "granularity": {"type": "string", "description": "Data granularity (hour, day, week, month)", "required": False, "default": "day"},
                "zone_ids": {"type": "array", "description": "Specific zones", "required": False}
            },
        ...
        self.tools["generate_report"] = MCPTool(
            ...
            tool_type=MCPToolType.FUNCTION,
            parameters={
                "report_type": {"type": "string", "description": "Type of report", "required": True},
                "parameters": {"type": "object", "description": "Report parameters", "required": False},
                "format": {"type": "string", "description": "Output format (pdf, excel, csv)", "required": False, "default": "pdf"},
                "email_to": {"type": "array", "description": "Email recipients", "required": False}
            },
