...
class IoTAdapter(MCPAdapter):
    ...
    def _setup_tools(self) -> None:
        ...
        self.tools["get_equipment_status"] = MCPTool(
            ...
            parameters={
                "equipment_ids": {"type": "array", "description": "List of equipment IDs to query", "required": False},
                "equipment_types": {"type": "array", "description": "Filter by equipment types", "required": False},
                "include_telemetry": {"type": "boolean", "description": "Include telemetry data", "required": False, "default": True},
                "include_alerts": {"type": "boolean", "description": "Include active alerts", "required": False, "default": True}
            },
        ...
        self.tools["get_equipment_telemetry"] = MCPTool(
            ...
            tool_type=MCPToolType.FUNCTION,
            parameters={
                "equipment_id": {"type": "string", "description": "Equipment ID", "required": True},
                "sensor_types": {"type": "array", "description": "Types of sensors to query", "required": False},
                "time_range": {"type": "object", "description": "Time range for data", "required": False},
                "aggregation": {"type": "string", "description": "Data aggregation (raw, minute, hour, day)", "required": False, "default": "raw"}
            },
        ...
        self.tools["control_equipment"] = MCPTool(
            ...
            parameters={
                "equipment_id": {"type": "string", "description": "Equipment ID", "required": True},
                "command": {"type": "string", "description": "Control command", "required": True},
                "parameters": {"type": "object", "description": "Command parameters", "required": False},
                "priority": {"type": "string", "description": "Command priority (low, normal, high, emergency)", "required": False, "default": "normal"}
            },
        ...
        self.tools["get_environmental_data"] = MCPTool(
            ...
            tool_type=MCPToolType.FUNCTION,
            parameters={
                "zone_ids": {"type": "array", "description": "Zone IDs to query", "required": False},
                "sensor_types": {"type": "array", "description": "Sensor types (temperature, humidity, air_quality)", "required": False},
                "time_range": {"type": "object", "description": "Time range for data", "required": False},
                "thresholds": {"type": "object", "description": "Alert thresholds", "required": False}
            },
        ...
        self.tools["set_environmental_controls"] = MCPTool(
            ...
            tool_type=MCPToolType.FUNCTION,
            parameters={
                "zone_id": {"type": "string", "description": "Zone ID", "required": True},
                "control_type": {"type": "string", "description": "Control type (hvac, lighting, ventilation)", "required": True},
                "target_value": {"type": "number", "description": "Target value", "required": True},
        ...
        self.tools["get_safety_alerts"] = MCPTool(
            ...
            tool_type=MCPToolType.FUNCTION,
            parameters={
                "alert_types": {"type": "array", "description": "Types of alerts to query", "required": False},
                "severity_levels": {"type": "array", "description": "Severity levels (low, medium, high, critical)", "required": False},
                "zone_ids": {"type": "array", "description": "Zone IDs to filter", "required": False},
                "include_resolved": {"type": "boolean", "description": "Include resolved alerts", "required": False, "default": False}
            },
        ...
        self.tools["acknowledge_safety_alert"] = MCPTool(
            ...
            tool_type=MCPToolType.FUNCTION,
            parameters={
                "alert_id": {"type": "string", "description": "Alert ID", "required": True},
                "user_id": {"type": "string", "description": "User acknowledging", "required": True},
                "action_taken": {"type": "string", "description": "Action taken", "required": True},
        ...
        self.tools["track_assets"] = MCPTool(
            ...
            tool_type=MCPToolType.FUNCTION,
            parameters={
                "asset_ids": {"type": "array", "description": "Asset IDs to track", "required": False},
                "asset_types": {"type": "array", "description": "Asset types to track", "required": False},
                "zone_ids": {"type": "array", "description": "Zones to search in", "required": False},
                "include_history": {"type": "boolean", "description": "Include movement history", "required": False, "default": False}
            },
        ...
        self.tools["get_asset_location"] = MCPTool(
            ...
            tool_type=MCPToolType.FUNCTION,
            parameters={
                "asset_id": {"type": "string", "description": "Asset ID", "required": True},
                "include_accuracy": {"type": "boolean", "description": "Include location accuracy", "required": False, "default": True},
                "include_timestamp": {"type": "boolean", "description": "Include last seen timestamp", "required": False, "default": True}
            },
        ...
        self.tools["get_maintenance_alerts"] = MCPTool(
            ...
            tool_type=MCPToolType.FUNCTION,
            parameters={
                "equipment_ids": {"type": "array", "description": "Equipment IDs to query", "required": False},
                "alert_types": {"type": "array", "description": "Types of maintenance alerts", "required": False},
                "severity_levels": {"type": "array", "description": "Severity levels", "required": False},
                "include_recommendations": {"type": "boolean", "description": "Include maintenance recommendations", "required": False, "default": True}
            },
        ...
        self.tools["schedule_maintenance"] = MCPTool(
            ...
            parameters={
                "equipment_id": {"type": "string", "description": "Equipment ID", "required": True},
                "maintenance_type": {"type": "string", "description": "Type of maintenance", "required": True},
                "scheduled_date": {"type": "string", "description": "Scheduled date and time", "required": True},
                "technician_id": {"type": "string", "description": "Assigned technician", "required": False},
                "priority": {"type": "string", "description": "Priority level", "required": False, "default": "normal"},
                "description": {"type": "string", "description": "Maintenance description", "required": False}
            },
        ...
        self.tools["get_iot_analytics"] = MCPTool(
            ...
            tool_type=MCPToolType.FUNCTION,
            parameters={
                "analysis_type": {"type": "string", "description": "Type of analysis", "required": True},
                "time_range": {"type": "object", "description": "Time range for analysis", "required": True},
                "equipment_ids": {"type": "array", "description": "Equipment IDs to analyze", "required": False},
                "zone_ids": {"type": "array", "description": "Zone IDs to analyze", "required": False},
        ...
        self.tools["generate_iot_report"] = MCPTool(
            ...
            parameters={
                ...
                "time_range": {"type": "object", "description": "Time range for report", "required": True},
                "equipment_types": {"type": "array", "description": "Equipment types to include", "required": False},
                "zone_ids": {"type": "array", "description": "Zone IDs to include", "required": False},
        ...
        self.tools["register_device"] = MCPTool(
            ...
            tool_type=MCPToolType.FUNCTION,
            parameters={
                "device_id": {"type": "string", "description": "Device ID", "required": True},
                "device_type": {"type": "string", "description": "Device type", "required": True},
                "location": {"type": "object", "description": "Device location", "required": True},
                "capabilities": {"type": "array", "description": "Device capabilities", "required": True},
                "configuration": {"type": "object", "description": "Device configuration", "required": False}
            },
        ...
        self.tools["update_device_config"] = MCPTool(
            ...
            parameters={
                "device_id": {"type": "string", "description": "Device ID", "required": True},
                "configuration": {"type": "object", "description": "New configuration", "required": True},
                "restart_device": {"type": "boolean", "description": "Restart device after update", "required": False, "default": False}
            },
    ...
    async def connect(self) -> bool:
        ...
        try:
            ...
            logger.info(f"Connected to {self.iot_config.iot_platform} IoT platform successfully")
            return True
