...
from ..base import MCPAdapter, MCPToolBase, AdapterConfig, ToolConfig, AdapterType, ToolCategory
...
class RFIDBarcodeConfig(AdapterConfig):
    ...
    system_type: str = "rfid_uhf"  # rfid_uhf, rfid_hf, rfid_lf, barcode_1d, barcode_2d, qr_code, mixed
...
class RFIDBarcodeAdapter(MCPAdapter):
    ...
    def _setup_tools(self) -> None:
        ...
        self.tools["read_rfid_tags"] = MCPTool(
            ...
            parameters={
                "reader_ids": {"type": "array", "description": "Reader IDs to use", "required": False},
                "antenna_ids": {"type": "array", "description": "Antenna IDs to use", "required": False},
                "power_level": {"type": "integer", "description": "Reader power level", "required": False, "default": 100},
                "read_timeout": {"type": "integer", "description": "Read timeout in seconds", "required": False, "default": 5},
                "include_rssi": {"type": "boolean", "description": "Include RSSI values", "required": False, "default": True}
            },
        ...
        self.tools["write_rfid_tag"] = MCPTool(
            ...
            tool_type=MCPToolType.FUNCTION,
            parameters={
                "tag_id": {"type": "string", "description": "Tag ID to write to", "required": True},
                "data": {"type": "string", "description": "Data to write", "required": True},
                "memory_bank": {"type": "string", "description": "Memory bank (epc, tid, user)", "required": False, "default": "user"},
                "reader_id": {"type": "string", "description": "Reader ID to use", "required": True},
                "verify_write": {"type": "boolean", "description": "Verify write operation", "required": False, "default": True}
            },
        ...
        self.tools["inventory_rfid_tags"] = MCPTool(
            ...
            parameters={
                "reader_ids": {"type": "array", "description": "Reader IDs to use", "required": False},
                "duration": {"type": "integer", "description": "Inventory duration in seconds", "required": False, "default": 10},
                "filter_tags": {"type": "array", "description": "Filter specific tag patterns", "required": False},
                "include_timestamps": {"type": "boolean", "description": "Include read timestamps", "required": False, "default": True}
            },
        ...
        self.tools["scan_barcode"] = MCPTool(
            ...
            tool_type=MCPToolType.FUNCTION,
            parameters={
                "scanner_id": {"type": "string", "description": "Scanner ID to use", "required": True},
                "barcode_type": {"type": "string", "description": "Expected barcode type", "required": False},
                "timeout": {"type": "integer", "description": "Scan timeout in seconds", "required": False, "default": 5},
                "validate_format": {"type": "boolean", "description": "Validate barcode format", "required": False, "default": True}
            },
        ...
        self.tools["batch_scan_barcodes"] = MCPTool(
            ...
            tool_type=MCPToolType.FUNCTION,
            parameters={
                "scanner_ids": {"type": "array", "description": "Scanner IDs to use", "required": False},
                "max_scans": {"type": "integer", "description": "Maximum number of scans", "required": False, "default": 100},
                "scan_interval": {"type": "integer", "description": "Interval between scans", "required": False, "default": 1},
                "stop_on_duplicate": {"type": "boolean", "description": "Stop on duplicate scan", "required": False, "default": False}
            },
        ...
        self.tools["validate_barcode"] = MCPTool(
            ...
            tool_type=MCPToolType.FUNCTION,
            parameters={
                "barcode_data": {"type": "string", "description": "Barcode data to validate", "required": True},
                "barcode_type": {"type": "string", "description": "Expected barcode type", "required": False},
                "check_digit": {"type": "boolean", "description": "Validate check digit", "required": False, "default": True},
                "format_validation": {"type": "boolean", "description": "Validate format", "required": False, "default": True}
            },
        ...
        self.tools["track_asset"] = MCPTool(
            ...
            tool_type=MCPToolType.FUNCTION,
            parameters={
                "asset_identifier": {"type": "string", "description": "Asset identifier", "required": True},
                "identifier_type": {"type": "string", "description": "Type of identifier (rfid, barcode, qr)", "required": True},
                "location": {"type": "object", "description": "Current location", "required": False},
                "user_id": {"type": "string", "description": "User performing tracking", "required": False},
                "include_history": {"type": "boolean", "description": "Include tracking history", "required": False, "default": False}
            },
        ...
        self.tools["get_asset_info"] = MCPTool(
            ...
            parameters={
                "asset_identifier": {"type": "string", "description": "Asset identifier", "required": True},
                "identifier_type": {"type": "string", "description": "Type of identifier", "required": True},
                "include_location": {"type": "boolean", "description": "Include current location", "required": False, "default": True},
                "include_status": {"type": "boolean", "description": "Include asset status", "required": False, "default": True}
            },
        ...
        self.tools["perform_cycle_count"] = MCPTool(
            ...
            tool_type=MCPToolType.FUNCTION,
            parameters={
                "location_ids": {"type": "array", "description": "Location IDs to count", "required": True},
                "scan_type": {"type": "string", "description": "Scan type (rfid, barcode, both)", "required": True},
                "expected_items": {"type": "array", "description": "Expected items", "required": False},
                "tolerance": {"type": "number", "description": "Tolerance for discrepancies", "required": False, "default": 0.05},
                "user_id": {"type": "string", "description": "User performing count", "required": True}
            },
        ...
        self.tools["reconcile_inventory"] = MCPTool(
            ...
            tool_type=MCPToolType.FUNCTION,
            parameters={
                "count_id": {"type": "string", "description": "Cycle count ID", "required": True},
                "discrepancies": {"type": "array", "description": "List of discrepancies", "required": True},
                "adjustment_reason": {"type": "string", "description": "Reason for adjustment", "required": True},
                "user_id": {"type": "string", "description": "User performing reconciliation", "required": True}
            },
        ...
        self.tools["start_mobile_scanning"] = MCPTool(
            ...
            parameters={
                ...
                "device_id": {"type": "string", "description": "Mobile device ID", "required": True},
                "scan_mode": {"type": "string", "description": "Scan mode (rfid, barcode, both)", "required": True},
                "location": {"type": "object", "description": "Starting location", "required": False},
                "session_timeout": {"type": "integer", "description": "Session timeout in minutes", "required": False, "default": 60}
            },
        ...
        self.tools["stop_mobile_scanning"] = MCPTool(
            ...
            parameters={
                ...
                "user_id": {"type": "string", "description": "User ID", "required": True},
                "save_data": {"type": "boolean", "description": "Save scanned data", "required": False, "default": True}
            },
        ...
        self.tools["process_scan_data"] = MCPTool(
            ...
            tool_type=MCPToolType.FUNCTION,
            parameters={
                "scan_data": {"type": "array", "description": "Raw scan data", "required": True},
                "data_type": {"type": "string", "description": "Type of data (rfid, barcode, qr)", "required": True},
                "validation_rules": {"type": "object", "description": "Validation rules", "required": False},
                "deduplication": {"type": "boolean", "description": "Remove duplicates", "required": False, "default": True}
            },
        ...
        self.tools["export_scan_data"] = MCPTool(
            ...
            tool_type=MCPToolType.FUNCTION,
            parameters={
                "data_ids": {"type": "array", "description": "Data IDs to export", "required": False},
                "export_format": {"type": "string", "description": "Export format (csv, excel, json)", "required": False, "default": "csv"},
                "date_range": {"type": "object", "description": "Date range filter", "required": False},
                "include_metadata": {"type": "boolean", "description": "Include metadata", "required": False, "default": True}
            },
        ...
        self.tools["get_reader_status"] = MCPTool(
            ...
            tool_type=MCPToolType.FUNCTION,
            parameters={
                "reader_ids": {"type": "array", "description": "Reader IDs to query", "required": False},
                "include_health": {"type": "boolean", "description": "Include health metrics", "required": False, "default": True},
                "include_configuration": {"type": "boolean", "description": "Include configuration", "required": False, "default": False}
            },
        ...
        self.tools["configure_reader"] = MCPTool(
            ...
            tool_type=MCPToolType.FUNCTION,
            parameters={
                "reader_id": {"type": "string", "description": "Reader ID", "required": True},
                "settings": {"type": "object", "description": "Reader settings", "required": True},
                "apply_immediately": {"type": "boolean", "description": "Apply immediately", "required": False, "default": True}
            },
    ...
    async def connect(self) -> bool:
        ...
        try:
            ...
            logger.info(f"Connected to {self.rfid_config.system_type} system successfully")
            return True
        ...
        try:
            ...
            return {
                ...
                "data": {
                    ...
                    "reader_id": kwargs.get("reader_ids", ["default"])[0] if kwargs.get("reader_ids") else "default"
                }
            }
        except Exception as e:
            ...
            return {
                ...
                "data": {
                    ...
                    "asset_info": {
                        ...
                        "name": "Pallet A1",
                        "status": "in_use",
                        "location": kwargs.get("location", {"zone": "A", "coordinates": [10, 20]})
                    },
