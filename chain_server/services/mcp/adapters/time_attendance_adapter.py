...
class TimeAttendanceAdapter(MCPAdapter):
    ...
    def _setup_tools(self) -> None:
        ...
        self.tools["clock_in"] = MCPTool(
            ...
            parameters={
                ...
                "device_id": {"type": "string", "description": "Clock device ID", "required": True},
                "location": {"type": "object", "description": "Clock in location", "required": False},
                "shift_id": {"type": "string", "description": "Shift ID", "required": False},
        ...
        self.tools["clock_out"] = MCPTool(
            ...
            parameters={
                "employee_id": {"type": "string", "description": "Employee ID", "required": True},
                "device_id": {"type": "string", "description": "Clock device ID", "required": True},
                "location": {"type": "object", "description": "Clock out location", "required": False},
                "notes": {"type": "string", "description": "Additional notes", "required": False}
            },
        ...
        self.tools["get_clock_status"] = MCPTool(
            ...
            tool_type=MCPToolType.FUNCTION,
            parameters={
                "employee_ids": {"type": "array", "description": "Employee IDs to query", "required": False},
                "department_ids": {"type": "array", "description": "Department IDs to query", "required": False},
                "include_location": {"type": "boolean", "description": "Include location data", "required": False, "default": True},
                "include_duration": {"type": "boolean", "description": "Include work duration", "required": False, "default": True}
            },
        ...
        self.tools["start_break"] = MCPTool(
            ...
            parameters={
                "employee_id": {"type": "string", "description": "Employee ID", "required": True},
                "break_type": {"type": "string", "description": "Type of break (meal, rest, personal)", "required": True},
                "device_id": {"type": "string", "description": "Device ID", "required": True},
                "location": {"type": "object", "description": "Break location", "required": False},
                "expected_duration": {"type": "integer", "description": "Expected duration in minutes", "required": False}
            },
        ...
        self.tools["end_break"] = MCPTool(
            ...
            parameters={
                "employee_id": {"type": "string", "description": "Employee ID", "required": True},
                "device_id": {"type": "string", "description": "Device ID", "required": True},
                "location": {"type": "object", "description": "End break location", "required": False}
            },
        ...
        self.tools["get_break_status"] = MCPTool(
            ...
            parameters={
                "employee_ids": {"type": "array", "description": "Employee IDs to query", "required": False},
                "break_types": {"type": "array", "description": "Break types to filter", "required": False},
                "include_duration": {"type": "boolean", "description": "Include break duration", "required": False, "default": True}
            },
        ...
        self.tools["assign_shift"] = MCPTool(
            ...
            parameters={
                ...
                "start_date": {"type": "string", "description": "Shift start date", "required": True},
                "end_date": {"type": "string", "description": "Shift end date", "required": True},
                "assigned_by": {"type": "string", "description": "Assigned by user ID", "required": True}
            },
        ...
        self.tools["get_shift_schedule"] = MCPTool(
            ...
            parameters={
                ...
                "include_breaks": {"type": "boolean", "description": "Include break information", "required": False, "default": True}
            },
        ...
        self.tools["modify_shift"] = MCPTool(
            ...
            parameters={
                "shift_id": {"type": "string", "description": "Shift ID", "required": True},
                "modifications": {"type": "object", "description": "Shift modifications", "required": True},
                "reason": {"type": "string", "description": "Reason for modification", "required": True},
                "modified_by": {"type": "string", "description": "Modified by user ID", "required": True}
            },
        ...
        self.tools["calculate_overtime"] = MCPTool(
            ...
            tool_type=MCPToolType.FUNCTION,
            parameters={
                "employee_ids": {"type": "array", "description": "Employee IDs to calculate", "required": False},
                "pay_period": {"type": "object", "description": "Pay period dates", "required": True},
                "overtime_rules": {"type": "object", "description": "Overtime calculation rules", "required": False},
                "include_breaks": {"type": "boolean", "description": "Include break time in calculation", "required": False, "default": True}
            },
        ...
        self.tools["get_payroll_data"] = MCPTool(
            ...
            parameters={
                "employee_ids": {"type": "array", "description": "Employee IDs to query", "required": False},
                "pay_period": {"type": "object", "description": "Pay period dates", "required": True},
                "include_breakdown": {"type": "boolean", "description": "Include detailed breakdown", "required": False, "default": True},
                "format": {"type": "string", "description": "Output format (json, csv, excel)", "required": False, "default": "json"}
            },
        ...
        self.tools["get_attendance_report"] = MCPTool(
            ...
            parameters={
                ...
                "employee_ids": {"type": "array", "description": "Employee IDs to include", "required": False},
                "date_from": {"type": "string", "description": "Start date", "required": True},
                "date_to": {"type": "string", "description": "End date", "required": True},
                "include_breaks": {"type": "boolean", "description": "Include break data", "required": False, "default": True},
        ...
        self.tools["get_device_status"] = MCPTool(
            ...
            tool_type=MCPToolType.FUNCTION,
            parameters={
                "device_ids": {"type": "array", "description": "Device IDs to query", "required": False},
                "include_health": {"type": "boolean", "description": "Include health metrics", "required": False, "default": True},
                "include_usage": {"type": "boolean", "description": "Include usage statistics", "required": False, "default": False}
            },
        ...
        self.tools["configure_device"] = MCPTool(
            ...
            parameters={
                "device_id": {"type": "string", "description": "Device ID", "required": True},
                "settings": {"type": "object", "description": "Device settings", "required": True},
        ...
        self.tools["register_employee"] = MCPTool(
            ...
            parameters={
                "employee_id": {"type": "string", "description": "Employee ID", "required": True},
                "biometric_data": {"type": "object", "description": "Biometric data", "required": False},
                "card_number": {"type": "string", "description": "RFID card number", "required": False},
                "department_id": {"type": "string", "description": "Department ID", "required": False},
                "shift_preferences": {"type": "object", "description": "Shift preferences", "required": False}
            },
        ...
        self.tools["update_employee_info"] = MCPTool(
            ...
            parameters={
                "employee_id": {"type": "string", "description": "Employee ID", "required": True},
                "updates": {"type": "object", "description": "Information updates", "required": True},
                "updated_by": {"type": "string", "description": "Updated by user ID", "required": True}
            },
        ...
        self.tools["set_geofence"] = MCPTool(
            ...
            parameters={
                ...
                "coordinates": {"type": "array", "description": "Geofence coordinates", "required": True},
                "radius": {"type": "number", "description": "Geofence radius in meters", "required": True},
                "enabled": {"type": "boolean", "description": "Enable geofence", "required": False, "default": True}
            },
        ...
        self.tools["check_geofence"] = MCPTool(
            ...
            tool_type=MCPToolType.FUNCTION,
            parameters={
                "location": {"type": "object", "description": "Location to check", "required": True},
                "location_id": {"type": "string", "description": "Location ID", "required": True}
            },
    ...
    async def connect(self) -> bool:
        ...
        try:
            ...
            logger.info(f"Connected to {self.attendance_config.system_type} time attendance system successfully")
            return True
