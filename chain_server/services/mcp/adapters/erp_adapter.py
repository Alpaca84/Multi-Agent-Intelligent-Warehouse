...
class MCPERPAdapter(MCPAdapter):
    ...
    # Tool handlers
    async def _handle_get_customer_info(self, arguments: Dict[str, Any]) -> Dict[str, Any]:
    ...
    async def _handle_search_customers(self, arguments: Dict[str, Any]) -> Dict[str, Any]:
    ...
    async def _handle_update_order_status(self, arguments: Dict[str, Any]) -> Dict[str, Any]:
    ...
    async def _handle_get_inventory_levels(self, arguments: Dict[str, Any]) -> Dict[str, Any]:
    ...
    async def _handle_get_financial_summary(self, arguments: Dict[str, Any]) -> Dict[str, Any]:
        """Handle get financial summary tool."""
        try:
            start_date = arguments["start_date"]
            end_date = arguments["end_date"]
            
            financial_data = await self.erp_adapter.get_financial_summary(start_date, end_date)
    ...
    async def _handle_get_sales_report(self, arguments: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            sales_report = await self.erp_adapter.get_sales_report(start_date, end_date, group_by)
