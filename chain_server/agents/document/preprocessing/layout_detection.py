...
class LayoutDetectionService:
    ...
    async def detect_layout(self, preprocessing_result: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    async def _detect_page_layout(self, page_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            document_structure = await self._identify_document_structure(classified_elements)
    ...
    async def _classify_elements(self, elements: List[Dict[str, Any]], image: Image.Image) -> List[Dict[str, Any]]:
    ...
    def _enhance_element_classification(self, element: Dict[str, Any], image: Image.Image) -> str:
    ...
    def _extract_element_properties(self, element: Dict[str, Any], image: Image.Image) -> Dict[str, Any]:
    ...
    async def _identify_document_structure(self, elements: List[Dict[str, Any]]) -> Dict[str, Any]:
    ...
    def _determine_layout_type(self, elements: List[Dict[str, Any]]) -> str:
        ...
        table_count = sum(1 for e in elements if "table" in e["classified_type"].lower())
    ...
    def _calculate_overall_confidence(self, layout_results: List[Dict[str, Any]]) -> float:
