...
class NemotronParseService:
    ...
    def __init__(self):
        ...
        self.base_url = os.getenv("NEMO_PARSE_URL", "https://integrate.api.nvidia.com/v1")
        self.timeout = 60
    ...
    async def initialize(self):
        ...
        try:
            if not self.api_key:
                logger.warning("NEMO_PARSE_API_KEY not found, using mock implementation")
                return
    ...
    async def _parse_image(self, image: Image.Image, page_number: int) -> Dict[str, Any]:
    ...
    def _parse_parse_result(self, api_result: Dict[str, Any], image_size: tuple) -> Dict[str, Any]:
        ...
        for i, parse_result in enumerate(parse_results):
            ...
            enhanced_result = {
                **parse_result,
                ...
                "semantic_analysis": await self._perform_semantic_analysis(enhanced_elements),
    ...
    def _extract_context(self, element: Dict[str, Any], all_elements: List[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        return {
            ...
            "isolation_score": 1.0 - (len(nearby_elements) / 10)  # Less isolated = lower score
        }
    ...
    def _find_relationships(self, element: Dict[str, Any], all_elements: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
        ...
        for other_element in all_elements:
            ...
            if self._are_related(element, other_element):
                relationships.append({
                    ...
                    "relationship_type": self._get_relationship_type(element, other_element),
                    "strength": self._calculate_relationship_strength(element, other_element)
                })
    ...
    def _are_related(self, element1: Dict[str, Any], element2: Dict[str, Any]) -> bool:
        ...
        for pattern1, pattern2 in related_patterns:
            if (pattern1 in text1 and pattern2 in text2) or (pattern1 in text2 and pattern2 in text1):
                return True
        
        return False
    
    def _get_relationship_type(self, element1: Dict[str, Any], element2: Dict[str, Any]) -> str:
    ...
    def _calculate_relationship_strength(self, element1: Dict[str, Any], element2: Dict[str, Any]) -> float:
    ...
    async def _perform_semantic_analysis(self, elements: List[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        confidence_scores = [elem["confidence"] for elem in elements]
        analysis["data_quality"] = sum(confidence_scores) / len(confidence_scores) if confidence_scores else 0.0
        
        # Calculate completeness
        required_fields = ["document_title", "vendor_info", "date_field", "total_amount"]
    ...
    async def _mock_parse_extraction(self, image: Image.Image, page_number: int) -> Dict[str, Any]:
