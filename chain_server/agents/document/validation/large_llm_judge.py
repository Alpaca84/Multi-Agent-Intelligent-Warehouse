...
class LargeLLMJudge:
    ...
    def __init__(self):
        ...
        self.base_url = os.getenv("LLAMA_70B_URL", "https://integrate.api.nvidia.com/v1")
        self.timeout = 60
    ...
    async def evaluate_document(
        ...
        try:
            ...
            evaluation_prompt = self._create_evaluation_prompt(structured_data, entities, document_type)
            ...
            logger.info(f"Judge evaluation completed with overall score: {judge_evaluation.overall_score}")
    ...
    def _parse_judge_result(self, result: Dict[str, Any], document_type: str) -> JudgeEvaluation:
        ...
        try:
            ...
            if "raw_text" in content:
                ...
                return self._parse_raw_judge_response(content["raw_text"], document_type)
    ...
    def _parse_raw_judge_response(self, raw_text: str, document_type: str) -> JudgeEvaluation:
    ...
    async def _mock_judge_evaluation(self, document_type: str) -> Dict[str, Any]:
        ...
        mock_evaluations = {
            ...
            "receipt": {
                ...
                "issues_found": ["Missing transaction time", "Item categorization unclear"],
                "confidence": 0.85,
