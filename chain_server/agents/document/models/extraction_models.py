...
class OCRResult(BaseModel):
    ...
    words: List[Dict[str, Any]] = Field(default_factory=list, description="Word-level data")
...
class QualityAssessment(BaseModel):
    ...
    completeness_score: float = Field(..., ge=1.0, le=5.0, description="Completeness score")
    accuracy_score: float = Field(..., ge=1.0, le=5.0, description="Accuracy score")
    consistency_score: float = Field(..., ge=1.0, le=5.0, description="Consistency score")
    readability_score: float = Field(..., ge=1.0, le=5.0, description="Readability score")
...
class JudgeEvaluation(BaseModel):
    ...
    overall_score: float = Field(..., ge=1.0, le=5.0, description="Overall evaluation score")
    ...
    accuracy: Dict[str, Any] = Field(default_factory=dict, description="Accuracy assessment")
    compliance: Dict[str, Any] = Field(default_factory=dict, description="Compliance assessment")
    quality: Dict[str, Any] = Field(default_factory=dict, description="Quality assessment")
...
class ProcessingStageResult(BaseModel):
    ...
    result_data: Dict[str, Any] = Field(default_factory=dict, description="Stage result data")
...
class WorkflowProgress(BaseModel):
    ...
    stages_completed: List[str] = Field(default_factory=list, description="Completed stages")
    stages_pending: List[str] = Field(default_factory=list, description="Pending stages")
...
class ProcessingStatistics(BaseModel):
    ...
    success_rate_percentage: float = Field(..., ge=0.0, le=100.0, description="Success rate")
    average_quality_score: float = Field(..., ge=1.0, le=5.0, description="Average quality score")
