...
from chain_server.agents.document.models.document_models import (
    ProcessingStage, ProcessingStatus, RoutingAction, QualityDecision
)
...
class WorkflowManager:
    ...
    async def update_workflow_stage(
        ...
        try:
            ...
            logger.info(f"Updated workflow {workflow_id} to stage {stage.value} ({workflow_state.progress_percentage:.1f}% complete)")
    ...
    async def get_workflow_history(self, document_id: Optional[str] = None) -> List[WorkflowState]:
    ...
    async def retry_workflow_stage(
        ...
        try:
            ...
            logger.info(f"Retrying workflow {workflow_id}, stage {stage.value} (attempt {retry_count + 1})")
            return True
    ...
    async def get_workflow_statistics(self) -> Dict[str, Any]:
        ...
        try:
            ...
            success_rate = (
                ...
                if self.workflow_history else 0.0
            )
    ...
    async def get_workflow_progress(self, workflow_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "stages_pending": [stage.value for stage in workflow_state.stages_pending],
    ...
    def _estimate_completion_time(self, workflow_state: WorkflowState) -> Optional[str]:
        ...
        try:
            ...
            elapsed_time = (workflow_state.last_updated - workflow_state.start_time).total_seconds()
